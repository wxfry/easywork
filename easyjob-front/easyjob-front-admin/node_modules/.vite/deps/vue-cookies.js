...
var require_vue_cookies = __commonJS({
  "node_modules/vue-cookies/vue-cookies.js"(exports, module) {
    (function() {
      var defaultConfig = {
        expires: "1d",
        path: "; path=/",
      ...
      var VueCookies = {
        ...
        install: function(Vue2, options) {
          if (options)
            this.config(options.expires, options.path, options.domain, options.secure, options.sameSite, options.partitioned);
          if (Vue2.prototype)
        ...
        set: function(key, value, expires, path, domain, secure, sameSite, partitioned) {
          ...
          document.cookie = encodeURIComponent(key) + "=" + encodeURIComponent(value) + _expires + (domain ? "; domain=" + domain : defaultConfig.domain) + (path ? "; path=" + path : defaultConfig.path) + (secure === void 0 ? defaultConfig.secure : secure ? "; Secure" : "") + (sameSite === void 0 ? defaultConfig.sameSite : sameSite ? "; SameSite=" + sameSite : "") + (partitioned === void 0 ? defaultConfig.partitioned : partitioned ? "; Partitioned" : "");
          return this;
        },

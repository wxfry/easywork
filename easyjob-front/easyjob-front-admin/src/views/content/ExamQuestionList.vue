...
<!--            </el-col>-->
            ...
            <el-col :span="5">
              <el-form-item label="老师" label-width="50px">
                <el-input v-model="searchForm.teacherFuzzy" clearable placeholder="支持模糊搜索" @keyup.enter="loadDataList">
                </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="知识点" label-width="60px">
                <el-input v-model="searchForm.knowledgePointsFuzzy" clearable placeholder="支持模糊搜索" @keyup.enter="loadDataList">
                </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="来源" label-width="50px">
                <el-input v-model="searchForm.originFuzzy" clearable placeholder="支持模糊搜索" @keyup.enter="loadDataList">
                </el-input>
              </el-form-item>
            </el-col>
...
<!--            </el-col>-->
          ...
          <el-row class="second-row">
            <el-col :span="5">
              <el-form-item label="章节" label-width="50px">
                <el-input v-model="searchForm.chapterFuzzy" clearable placeholder="支持模糊搜索" @keyup.enter="loadDataList">
                </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="5">
...
<!--              </el-form-item>-->
<!--            </el-col>-->
            <el-col :span="14" :style="{ paddingLeft: '10px', position: 'absolute', right: '120px'}">
              <el-button-group>

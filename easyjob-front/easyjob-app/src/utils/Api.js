const api = {
    //接口域名
    // domain: "http://192.168.156.1:9090",
    // domain: "http://192.168.61.138:9090",
    // domain: "http://192.168.3.3:9090",
    domain: "http://192.168.39.138:9090",
    ...
    loadQuestion1: "/question/loadQuestion1",
    // 获取分类
    loadClassify: "/index/loadClassify",
    //下一篇问题
    ...
    // 创建练习
    createTexts: "/appExam/createText",
    // 创建历年真题练习
    createPostPaperText: "/appText/createPostPaperText",
    // 创建错题练习
    createWrongText: "/my/createWrongText",
    //开始考试
    startExam: "/appExam/startExam",
    //获取考试题目
    getExamQuestion: "/appExam/getExamQuestion",
    // 获取练习
    getAppText: "/appText/getText",
    // 获取练习题目
    getAppTextQuestion: "/appText/getTextQuestion",
    // 获取练习历史
    getTextHistory: "/appText/getTextHistory",
    // 提交练习
    postText: "/appText/postText",
    // 提交练习题目
    postTextQuestion: "/appText/postTextQuestion",
    //提交考题
    ...
    // 推荐联系
    // commendPractice: "/commend/userCF",
    getCommendPractice: "/commend/getCommendPractice",
    // 签到
    sign: "/commend/sign",
    // 当月签到详情
    signDetail: "/commend/getSignDetail",
    // 获取练习数据
    getTextData: "/commend/getTextData",

    // 获取图表练习数据
    getTextQuestionData: "/commend/getTextQuestionData",
    getExamStatistics: "/commend/getExamStatistics",
    // 相似度计算
    calculateTopNUserSimilarity: "/commend/calculateTopNUserSimilarity",

    // 图片识别
    getUserKnowledgeMatrix: "/commend/getUserKnowledgeMatrix",
}

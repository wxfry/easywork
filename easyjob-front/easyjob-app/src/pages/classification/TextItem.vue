...
<template>
  ...
  >
    <view class="question-content">
      ...
      <!-- 问题答案 -->
      <view class="question-answer" v-if="data.answerResult !== 0 ">
        <text>答案</text>
...
// const emit = defineEmits(["update:modelValue", "answerChange"]); // 添加 answerChange 事件
...
const getAnswer = (item, answerType) => {
  // console.log("getAnswer", item, answerType)
  ...
  if (item.questionType == 0) {
    ...
    // console.log("answerResult", answerResult.join("、"));

...
const pages_components_uvParse_components_uvParse_parser = require("./parser.js");
...
const _sfc_main = {
  ...
  methods: {
    ...
    setContent(content, append) {
      ...
      const nodes = new pages_components_uvParse_components_uvParse_parser.Parser(this).parse(content);
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "E:/easyjob/easyjob-front/easyjob-app/src/pages/components/uv-parse/components/uv-parse/uv-parse.vue"]]);

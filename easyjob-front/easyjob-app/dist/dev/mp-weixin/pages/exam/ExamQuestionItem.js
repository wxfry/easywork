...
if (!Math) {
  (_easycom_uni_data_checkbox + _easycom_uni_forms_item + _easycom_uni_rate + uvParse)();
}
...
const _sfc_main = {
  ...
  setup(__props, { emit }) {
    ...
    const formateAnswerOptions = (question) => {
      ...
      console.log("question.questionItemList------------", question.questionItemList);
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        f: __props.showAnswer
      }, __props.showAnswer ? common_vendor.e({
        g: common_vendor.t(getAnswer(__props.data, 0)),
        h: __props.data.answerResult != null && __props.data.answerResult != 0
      }, __props.data.answerResult != null && __props.data.answerResult != 0 ? common_vendor.e({
        i: common_vendor.t(getAnswer(__props.data, 1)),
        j: __props.data.answerResult == 1
      }, __props.data.answerResult == 1 ? {} : {}, {
        k: __props.data.answerResult == 2
      }, __props.data.answerResult == 2 ? {} : {}) : {}) : {}, {
        l: __props.showAnswer
      }, __props.showAnswer ? common_vendor.e({
        m: common_vendor.p({
          size: "20",
          readyonly: true,
        ...
        n: __props.data.answerAnalysis
      }, __props.data.answerAnalysis ? {
        o: common_vendor.p({
          content: __props.data.answerAnalysis
        })
      } : {}) : {}, {
        p: __props.height ? __props.height + "px" : "auto"
      });
    };
  }
};
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-dc11d100"], ["__file", "E:/easyjob/easyjob-front/easyjob-app/src/pages/exam/ExamQuestionItem.vue"]]);

...
public class Constants {
    ...
    public static final Integer LENGTH_300 = 300;
    ...
    public static final String[] EXCEL_TITLE_EXAM_QUESTION = new String[]{"标题", "分类名称", "老师", "知识点", "来源", "章节", "难度", "问题类型", "问题选项", "问题答案", "问题描述", "答案分析"};

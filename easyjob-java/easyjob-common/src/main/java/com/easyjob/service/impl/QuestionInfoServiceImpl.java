...
public class QuestionInfoServiceImpl implements QuestionInfoService {
    ...
    @Override
    public List<ExamQuestion> findListByParam1(ExamQuestionQuery param) {
    ...
    @Override
    public Integer findCountByParam1(ExamQuestionQuery param) {
    ...
    @Override
    public QuestionResultVO<ExamQuestion> findListByPage1(ExamQuestionQuery param) {
        int count = this.findCountByParam1(param);
        List<ExamQuestion> list = this.findListByParam1(param);
        QuestionResultVO<ExamQuestion> result = new QuestionResultVO(count, list);
        return result;
    }
